...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "DecisionBridge — AI-powered decision templates" },
      { name: "description", content: "AI-powered decision templates made easy with connectors from your own workspaces. Built for Infineon's engineering teams." },
      { name: "author", content: "Infineon Technologies" },
      { property: "og:site_name", content: "DecisionBridge" },
      { property: "og:title", content: "DecisionBridge — AI-powered decision templates" },
      { property: "og:description", content: "AI-powered decision templates made easy with connectors from your own workspaces." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://decision-bridge.vercel.app" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "DecisionBridge" },
      { name: "twitter:description", content: "AI-powered decision templates made easy with connectors from your own workspaces." },
    ],
    links: [
